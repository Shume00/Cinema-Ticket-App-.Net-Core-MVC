                ...
                if (!context.Movies.Any())
                {
                    context.Movies.AddRange(new List<Movie>()
                    {
                        new Movie()
                        {
                            ...
                            Price = 39.50,
                            PosterImage = "http://dotnethow.net/images/movies/movie-3.jpeg",
                        ...
                        new Movie()
                        {
                            ...
                            Price = 29.50,
                            PosterImage = "http://dotnethow.net/images/movies/movie-1.jpeg",
                        ...
                        new Movie()
                        {
                            ...
                            Price = 39.50,
                            PosterImage = "http://dotnethow.net/images/movies/movie-4.jpeg",
                            StartDate = DateTime.Now,
                        ...
                        new Movie()
                        {
                            ...
                            Price = 39.50,
                            PosterImage = "http://dotnethow.net/images/movies/movie-6.jpeg",
                            StartDate = DateTime.Now.AddDays(-10),
                        ...
                        new Movie()
                        {
                            ...
                            Price = 39.50,
                            PosterImage = "http://dotnethow.net/images/movies/movie-7.jpeg",
                            StartDate = DateTime.Now.AddDays(-10),
                        ...
                        new Movie()
                        {
                            ...
                            Price = 39.50,
                            PosterImage = "http://dotnethow.net/images/movies/movie-8.jpeg",
